      ...
      {/* <section className="relative bg-background">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-primary mb-4 text-balance">Our Printing Services</h2>
        ...
        <div className="hidden lg:block relative">
          {stackedServices.map((service, index) => (
            <div
              ...
              style={{ zIndex: stackedServices.length - index }}
            >
              <div className="container mx-auto px-4 py-20">
                <div className="grid grid-cols-2 gap-16 items-center">
                  <div className="space-y-6 pr-8">
                    <h3 className="text-5xl lg:text-6xl font-bold text-primary text-balance leading-tight">
                      {service.title}
                    </h3>
        ...
        <div className="lg:hidden space-y-16 pb-20">
          {stackedServices.map((service) => (
            <div key={service.title} className="container mx-auto px-4">
              <div className="space-y-6">
                ...
                <h3 className="text-3xl font-bold text-primary text-balance">{service.title}</h3>
                <p className="text-base text-foreground leading-relaxed">{service.description}</p>
                <Button onClick={() => setQuoteModalOpen(true)} className="bg-accent hover:bg-accent/90 text-white">
                  Request Quote
